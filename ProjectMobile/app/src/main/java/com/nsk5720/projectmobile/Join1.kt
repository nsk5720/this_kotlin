...
import com.nsk5720.projectmobile.databinding.ActivityJoin1Binding
...
class Join1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val intent2 = Intent(this, Join2::class.java)
    ...
    fun signup() {
        with(binding) {
            // 1. 입력된 값을 가져오고
            val id = editIdJoin.text.toString()
            val password = editPasswordJoin.text.toString()
            val name = editNameJoin.text.toString()
