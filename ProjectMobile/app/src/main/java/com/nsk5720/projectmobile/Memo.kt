...
import com.nsk5720.memo.MemoAdapter
import com.nsk5720.projectmobile.databinding.ActivityMemoBinding
...
class Memo : AppCompatActivity() {
    ...
    fun refreshAdapter(adapter:MemoAdapter) {
        adapter.listData.clear()
