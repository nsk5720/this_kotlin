...
import com.nsk5720.projectmobile.databinding.MusicplayitemBinding
...
class MusicRecyclerAdapter: RecyclerView.Adapter<MusicRecyclerAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val binding = MusicplayitemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class Holder(val binding: MusicplayitemBinding) : RecyclerView.ViewHolder(binding.root) {
