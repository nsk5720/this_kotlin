...
import com.nsk5720.projectmobile.databinding.ActivityMapBinding
import data.Library
import data.Row
...
class Map : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent2 = Intent(this, HospitalList::class.java)
        binding.listBtn.setOnClickListener {
            startActivity(intent2)
        }
        val intent3 = Intent(this, DiagnosisList::class.java)
        binding.mapContactRes.setOnClickListener {
            startActivity(intent3)
        }
        val intent4 = Intent(this, ChatListActivity::class.java)
        binding.mapDiagnosis.setOnClickListener {
            startActivity(intent4)

        }
        val intent5 = Intent(this, MyPage::class.java)
        binding.mapMyPage.setOnClickListener {
